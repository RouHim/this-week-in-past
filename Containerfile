...
COPY --from=builder /usr/lib/samba/libcom-err-samba4.so /usr/lib/samba/libcom-err-samba4.so
...
COPY --from=builder /usr/lib/samba/libnpa-tstream-samba4.so /usr/lib/samba/libnpa-tstream-samba4.so
...
COPY --from=builder /usr/lib/samba/libkrb5-samba4.so /usr/lib/samba/libkrb5-samba4.so
...
COPY --from=builder /usr/lib/samba/libgssapi-samba4.so /usr/lib/samba/libgssapi-samba4.so
...
COPY --from=builder /usr/lib/samba/libasn1-samba4.so /usr/lib/samba/libasn1-samba4.so
...
COPY --from=builder /usr/lib/samba/libroken-samba4.so /usr/lib/samba/libroken-samba4.so
COPY --from=builder /usr/lib/samba/libhx509-samba4.so /usr/lib/samba/libhx509-samba4.so
COPY --from=builder /usr/lib/samba/libheimbase-samba4.so /usr/lib/samba/libheimbase-samba4.so
COPY --from=builder /usr/lib/samba/libwind-samba4.so /usr/lib/samba/libwind-samba4.so
COPY --from=builder /usr/lib/samba/libhcrypto-samba4.so /usr/lib/samba/libhcrypto-samba4.so
...
COPY --chown=$USER:$USER --from=builder /app/target/release/this-week-in-past /this-week-in-past
